PostsController = MeteorisController.extend({
    ...
    subscriptions: function() {
        ...
        /*Sub to categories instead
        this.subscription = this.subs.subscribe('categories', this.getCriteria(), sort);*/
    ...
    index: function() {
        ...
        /*What does this and the above do?, this should be our cat index*/
    ...
    insert: function(t) {
        if (this._post) {
            ...
            /*lets switch the above uploadImage function to parse for our lineItem and insert
            the below can insert our category name*/

            //set inserted doc
            var doc = this._getDoc(t);
            doc.imageId = imageId;

            /*This should insert categories instead*/
    ...
    /*TODO: Check the below code for refactor to categories/LineItems*/
